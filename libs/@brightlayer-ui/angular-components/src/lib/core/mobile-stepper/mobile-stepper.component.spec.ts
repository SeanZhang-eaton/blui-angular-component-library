...
class TestMobileStepperDotComponent {}

@Component({
  template: ` <blui-mobile-stepper [steps]="4" [activeStep]="0" variant="progress"></blui-mobile-stepper> `,
})
class TestMobileStepperProgressComponent {}

describe('DotStepperComponent', () => {
  let component: TestMobileStepperDotComponent;
  let fixture: ComponentFixture<TestMobileStepperDotComponent>;

  beforeEach(() => {
    void TestBed.configureTestingModule({
      declarations: [TestMobileStepperDotComponent, TestMobileStepperProgressComponent],
      imports: [MobileStepperModule],
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(TestMobileStepperDotComponent);
  ...
  it('should render progress indicator', () => {
    const progressFixture = TestBed.createComponent(TestMobileStepperProgressComponent);
