    ...
    <app-component-doc-scaffold mdFileName="ChannelValue.md" [knobGroups]="knobGroups">
      <div examples class="app-example">
        ...
        <div class="example-section">
          ...
          <div class="example-description">
            Some measurements may require the units to appear before the value. This can be achieved by setting the
            <code>prefix</code> input.
          </div>
          <div class="example-demo-wrapper">
        ...
        <div class="example-section">
          ...
          <div class="example-description">
            Some measurements require a space between the value and units, and some do not. The Channel Value handles
            this automatically for common units, but you can override this behavior through the
            <code>unitSpace</code> input.
          </div>
          <div class="example-demo-wrapper">
