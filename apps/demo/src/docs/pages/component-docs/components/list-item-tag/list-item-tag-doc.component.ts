      ...
      <div examples class="app-example">
        <div class="example-section">
          ...
          <div class="example-description">
            A <code>&lt;blui-list-item-tag&gt;</code> is a stylized text element used for labeling. Text and background
            colors are customizable via <code>fontColor</code> and <code>backgroundColor</code> inputs.
          </div>
...
export class ListItemTagDocComponent implements AfterViewInit {
