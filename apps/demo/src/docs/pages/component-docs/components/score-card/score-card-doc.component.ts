      ...
      <div examples class="app-example">
        <div class="example-section">
          ...
          <div class="example-description">
            <div>
              A <code>&lt;blui-score-card&gt;</code> is a card component that calls attention to particular values. It
              is frequently seen on dashboard interfaces.
            </div>
          </div>
        ...
        <div class="example-section">
          ...
          <div class="example-description">
            <div>
              A Score Card reserves space for <code>blui-badge</code> content. This space is commonly used to show
        ...
        <div class="example-section">
          ...
          <div class="example-description">
            <div>
              ...
              <code>blui-action-item</code> content or at the bottom of the card via the <code>blui-action-row</code>.
            </div>
          </div>
          <div class="example-demo-wrapper">
