    ...
    <ng-template #examples>
      <div class="app-example">
        <div class="example-section">
          ...
          <div class="example-description">
            Setting the variant to <code>'collapsed'</code> will lock the App Bar at its collapsed size and it will
            behave like a default toolbar.
          </div>
          <div class="example-demo-wrapper">
        ...
        <div class="example-section">
          ...
          <div class="example-description">
            You can nest content inside of the App Bar. The App Bar reserves space for icons on both the left
            (<code>blui-icon</code>) and right side (<code>blui-actions</code>).
          </div>
          <div class="example-demo-wrapper">
