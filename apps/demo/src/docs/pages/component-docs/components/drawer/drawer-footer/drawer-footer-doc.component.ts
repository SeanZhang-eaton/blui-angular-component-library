    ...
    <app-component-doc-scaffold [md]="md" [knobGroups]="knobGroups">
      <div examples class="app-example">
        ...
        <div class="example-section">
          <div class="example-heading">Drawer Footer</div>
          <div class="example-description">
            The <code>&lt;blui-drawer-footer&gt;</code> appears at the bottom of drawer and is used to display custom
            content.
          </div>
          <div class="example-demo-wrapper">
      ...
      <app-footer-playground playground [inputs]="knobs" (codeChange)="generatedCode = $event"></app-footer-playground>
...
export class DrawerFooterDocComponent implements OnInit {
  md: string;
  BASIC = BASIC;
  COMPLEX = COMPLEX;
