      ...
      <div examples class="app-example">
        <div class="example-section">
          ...
          <div class="example-description">
            A <code>&lt;blui-drawer-nav-item&gt;</code> represents a single list item in the navigation drawer. Nav
            items can contain any combination of title, subtitle and icon.
          </div>
        ...
        <div class="example-section">
          ...
          <div class="example-description">
            ...
            <code>selected</code> input. The shape of the highlight can be either "square" (default) or "round".
          </div>
          <div class="example-demo-wrapper">
...
export class DrawerNavItemDocComponent implements OnInit {
  md: string;
  BASIC = BASIC;
