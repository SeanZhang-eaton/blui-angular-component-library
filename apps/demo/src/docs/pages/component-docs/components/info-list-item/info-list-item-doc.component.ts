...
@Component({
  ...
  template: `
    <app-component-doc-scaffold [md]="md" mdFileName="InfoListItem.md" [knobGroups]="knobGroups">
      <div examples class="app-example">
        <div class="example-section">
          <div class="example-heading">Info List Item</div>
          <div class="example-description">
            A <code>&lt;blui-info-list-item&gt;</code> is a wrapper around the
            <a href="https://material.angular.io/components/list/overview" target="_blank"
              >Angular Material List Item</a
            >
            that provides convenient styling and content arrangement options. A basic use case displays a combination of
        ...
        <div class="example-section">
          ...
          <div class="example-description">
            When showing many list items, you can use the <code>dense</code> input to reduce their vertical padding and
            fit more list items on the page.
          </div>
          <div class="example-demo-wrapper">
        ...
        <div class="example-section">
          ...
          <div class="example-description">
            You can apply a status to a list item using the <code>statusColor</code> input. This will apply a colored
            stripe on the side of the list item and can be paired with the <code>avatar</code> input to add additional
            highlighting around the icon.
          </div>
          <div class="example-demo-wrapper">
        ...
        <div class="example-section">
          ...
          <div class="example-description">
            If you want to show additional content in the list item, such as a timestamp or action buttons, these can be
            provided through <code>blui-left-content</code> and / or <code>blui-right-content</code>.
          </div>
          <div class="example-demo-wrapper">
            <app-with-left-right-content-info-list-item-demo></app-with-left-right-content-info-list-item-demo>
          </div>
          <app-example-code [snippet]="LEFT_RIGHT_CONTENT" dataLine="3-6, 9"></app-example-code>
          <div class="example-actions">
            <app-copy-code-button [code]="LEFT_RIGHT_CONTENT"></app-copy-code-button>
          </div>
        </div>
        <div class="example-section">
...
export class InfoListItemDocComponent {
  ...
  STATUS = STATUS;
  ICON = ICON;
  LEFT_RIGHT_CONTENT = LEFT_RIGHT_CONTENT;
  ...
  otherProps = {
    ...
    showLeftContent: {
      label: 'Show Left Content',
      value: false,
      type: 'boolean',
    },
    showRightContent: {
      label: 'Show Right Content',
      value: true,
      type: 'boolean',
    },
  };
