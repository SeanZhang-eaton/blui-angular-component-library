      ...
      <div examples class="app-example">
        <div class="example-section">
          ...
          <div class="example-description">
            ...
            <a href="https://material.angular.io/components/menu/overview" target="_blank">Angular Material Menu</a>
            that is used to hold user account-related information and actions. It is typically located in the top corner
            of your application within a toolbar.
          </div>
        ...
        <div class="example-section">
          ...
          <div class="example-description">The User Menu supports multiple avatar formats (text, icon, image).</div>
          <div class="example-demo-wrapper">
        ...
        <div class="example-section">
          ...
          <div class="example-description">
            On larger screens the User Menu opens as a dropdown, but on smaller screens it opens as a bottomsheet. You
            can customize the point where this transition occurs via the
