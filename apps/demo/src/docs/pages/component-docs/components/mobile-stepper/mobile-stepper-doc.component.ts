      ...
      <div examples class="app-example">
        <div class="example-section">
          ...
          <div class="example-description">
            A <code>&lt;blui-mobile-stepper&gt;</code> shows users their progress while completing a workflow. Back and
            Next buttons can be projected to navigate through the steps. You can configure the Mobile Stepper to show
            progress via dots, text or an
