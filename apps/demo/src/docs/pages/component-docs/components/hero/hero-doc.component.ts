...
@Component({
  ...
  template: `
    <app-component-doc-scaffold mdFileName="Hero.md" [knobGroups]="knobGroups">
      <div examples class="app-example">
        <div class="example-section">
          ...
          <div class="example-description">
            A <code>&lt;blui-hero&gt;</code> is used to call attention to a particular value or parameter. It adds some
            additional visual elements onto a
            <a [routerLink]="createRouterLink(routes.channelValue.route)">Channel Value</a>. When showing multiple
            heroes, they are typically placed within a Hero Banner to help with layout.
          </div>
        ...
        <div class="example-section">
          ...
          <div class="example-description">
            By default, a Hero renders a single Channel Value. If you need to support multiple Channel Values, you can
            pass them in as content.
          </div>
          <div class="example-demo-wrapper">
        ...
        <div class="example-section">
          ...
          <div class="example-description">The primary icon of a Hero supports a variety of sizes and formats.</div>
          <div class="example-demo-wrapper">
      ...
      <app-hero-playground playground [inputs]="allProps" (codeChange)="generatedCode = $event"></app-hero-playground>
