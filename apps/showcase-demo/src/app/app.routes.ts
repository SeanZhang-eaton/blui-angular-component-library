...
export const appRoutes: Route[] = [
    ...
    },
    {
        ...
        loadComponent: () =>
            import('./pages/blui/navigation/navigation.component').then((m) => m.BluiNavigationComponent),
    },
    {
    ...
    },
    {
        ...
        loadComponent: () =>
            import('./pages/mat/navigation/navigation.component').then((m) => m.MatNavigationComponent),
    },
    {
    ...
    },
    {
        ...
        loadComponent: () =>
            import('./pages/templates/dashboard/dashboard.component').then((m) => m.DashboardComponent),
    },
    {
